...
Source: live PostgreSQL metadata via pg_proc
...
Note: functions in `public` may include PostgreSQL extension functions. Verify before treating them as business logic.
